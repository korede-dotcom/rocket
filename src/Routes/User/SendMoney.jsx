...
function SendMoney() {
  ...
  const sendObj = {
    ...
    promoCode: 12012,
    redirectURL:
      "https://rocket-5gw7-1i9y6fcex-koredebada-gmailcom.vercel.app/sendmoney?status",
    source: "web",
  };
                            ...
                            {d?.name === "Direct To Bank" ? (
                              ...
                              >
                                ...
                                <g clip-path="url(#clip0_400_9877)">
                                  <path
                                    d="M16.5234 10C13.4192 10 10 10.7726 10 12.3828C10 13.993 13.4192 14.7266 16.5234 14.7266C19.6277 14.7266 22.9687 13.993 22.9687 12.3828C22.9687 10.7726 19.6277 10 16.5234 10Z"
                                    fill="white"
                                  />
                                  <path
                                    d="M16.5234 15.8984C13.4179 15.8984 10 15.1602 10 13.5547V14.7266C10 16.332 13.4179 17.0703 16.5234 17.0703C19.6289 17.0703 22.9687 16.332 22.9687 14.7266V13.5547C22.9687 15.1602 19.6289 15.8984 16.5234 15.8984Z"
                                    fill="white"
                                  />
                                  <path
                                    d="M23.5547 17.0703C23.0918 17.0703 22.6552 17.1144 22.2672 17.1991C19.2786 17.8021 17.1094 20.4583 17.1094 23.5156C17.1094 25.3821 17.9133 27.1887 19.3129 28.4012C20.4905 29.4324 21.9966 30 23.5547 30C27.1086 30 30 27.0696 30 23.5156C30 19.9617 27.1086 17.0703 23.5547 17.0703ZM23.2137 22.9297H24.7266C25.0504 22.9297 25.3125 23.1918 25.3125 23.5156C25.3125 23.8395 25.0504 24.1016 24.7266 24.1016H23.2654C23.2199 24.3859 23.1333 24.6447 23.0099 24.878C23.3612 24.9799 23.6926 25.1687 23.9689 25.4451C24.3866 25.8628 25.0664 25.8628 25.4841 25.4451C25.713 25.2162 26.0838 25.2162 26.3127 25.4451C26.5416 25.674 26.5416 26.0448 26.3127 26.2737C25.8755 26.7108 25.3011 26.9294 24.7266 26.9294C24.1521 26.9294 23.5776 26.7108 23.1404 26.2737C22.832 25.9658 22.3451 25.8789 21.9577 26.0471C21.8198 26.1529 21.6785 26.2519 21.536 26.3469C21.2836 26.5146 20.9483 26.4631 20.7578 26.2307C20.5666 25.9979 20.5838 25.658 20.7967 25.4451C20.9586 25.2832 21.1394 25.151 21.3323 25.0491C21.7314 24.7301 21.952 24.4301 22.0549 24.1016H21.2109C20.8871 24.1016 20.625 23.8395 20.625 23.5156C20.625 23.1918 20.8871 22.9297 21.2109 22.9297H22.0197L21.8083 21.8728C21.7969 20.4652 22.848 19.4141 24.1406 19.4141C25.4332 19.4141 26.4844 20.4652 26.4844 21.7578C26.4844 22.0817 26.2223 22.3438 25.8984 22.3438C25.5746 22.3438 25.3125 22.0817 25.3125 21.7578C25.3125 21.1118 24.7866 20.5859 24.1406 20.5859C23.4946 20.5859 22.9687 21.1118 22.9687 21.7578L23.2137 22.9297Z"
                                    fill="white"
                                  />
                                  <path
                                    d="M17.1274 27.5896C16.9254 27.596 16.7237 27.6172 16.5234 27.6172C13.4179 27.6172 10 26.8789 10 25.2734V26.4453C10 28.0508 13.4179 28.8281 16.5234 28.8281C17.0261 28.8281 17.5188 28.7998 18.0021 28.7621C17.6718 28.4125 17.3829 27.9919 17.1274 27.5896Z"
                                    fill="white"
                                  />
                                  <path
                                    d="M16.1467 25.2679C13.1538 25.2106 10 24.4704 10 22.9297V24.1016C10 25.707 13.4179 26.4453 16.5234 26.4453C16.5259 26.4453 16.5286 26.445 16.5311 26.445C16.3725 26.0644 16.242 25.6718 16.1467 25.2679Z"
                                    fill="white"
                                  />
                                  <path
                                    d="M15.9898 22.9218C13.0474 22.8419 10 22.0997 10 20.5859V21.7578C10 23.2679 13.033 24.0104 15.9685 24.0933C15.9539 23.9014 15.9375 23.7097 15.9375 23.5156C15.9375 23.3138 15.9741 23.1203 15.9898 22.9218Z"
                                    fill="white"
                                  />
                                  <path
                                    d="M16.5234 20.5859C13.4179 20.5859 10 19.8477 10 18.2422V19.4141C10 20.959 13.1706 21.6989 16.1712 21.7526C16.2678 21.3505 16.3926 20.9613 16.5508 20.5849C16.5417 20.5849 16.5325 20.5859 16.5234 20.5859Z"
                                    fill="white"
                                  />
                                  <path
                                    d="M22.9648 15.928C22.9661 15.9279 22.9674 15.928 22.9687 15.9278V15.8984C22.9687 15.9087 22.9651 15.9179 22.9648 15.928Z"
                                    fill="white"
                                  />
                                  <path
                                    d="M16.5234 18.2422C13.4179 18.2422 10 17.5039 10 15.8984V17.0703C10 18.6758 13.4179 19.4141 16.5234 19.4141C16.7404 19.4141 16.9584 19.4096 17.1765 19.4023C17.4639 18.9574 17.7963 18.5475 18.1684 18.1713C17.6257 18.2179 17.0712 18.2422 16.5234 18.2422Z"
                                    fill="white"
                                  />
                                </g>
                                <defs>
