...
import { IconDown,IconMoreVertical,IconAlignCenter } from '@arco-design/web-react/icon';
  ...
  return (
    <Userlayout current="history" useBack={true}>
          <Content>
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handlesorts}>
            <path d="M3 7H21" stroke="#5A6376" stroke-width="1.5" stroke-linecap="round"/>
            <path d="M6 12H18" stroke="#5A6376" stroke-width="1.5" stroke-linecap="round"/>
            <path d="M10 17H14" stroke="#5A6376" stroke-width="1.5" stroke-linecap="round"/>
            </svg>
                ...
                showFilterOptions && (
                    <div className='filteroptions'>
                        {Object.keys(filteredData[0]).map((key) => (
                            <p onClick={(key) =>handleSort(key) } key={key}>{key}</p>
                        ))}
                    </div>
                )
            }
