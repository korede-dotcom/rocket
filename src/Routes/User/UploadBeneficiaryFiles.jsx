                        ...
                        <div className='sec'>
                            <SectionThree>
                                <div className='text'>
                                    ...
                                    <CustomSelect options={[]} styles={{fontSize:"10px ! important"}} placeholder="Photo ID Document" />
                                    ...
                                    <p className='textheader'>Comment</p>
                                        <TextArea name='address'  className="textarea" placeholder='Give comments ...' style={{ minHeight: 64, background:'transparent',border:"1px solid #d8d8d8",borderRadius:"8px"}} />
