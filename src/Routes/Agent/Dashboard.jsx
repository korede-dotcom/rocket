    ...
    const countryFlags = [
     ...
     const defaultCountrys =  Userdata?.data?.user?.wallet.map(d => {
      ...
      const updateCurrencyDetails = (countryLabel) => {
        ...
        console.log("🚀 ~ file: Dashboard.jsx:65 ~ transactionArray ~ transactionArray:", transactionArray)
            ...
            <div className='sel1'>
                <div className="container">
                    ...
                    <div className='wallets'>
                        <h5>{showbalance ? <AmountFormatter currency={currencyDetails[0]?.country?.currencyCode || 0} value={currencyDetails[0]?.balance || 0} />   : "****"}</h5>
                        {
                            showbalance ? (
